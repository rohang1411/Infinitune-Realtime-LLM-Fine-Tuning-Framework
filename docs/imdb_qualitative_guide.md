...
Results saved to: `output/qual_domain/eval_results/Qwen2.5-1.5B__imdb/<checkpoint>/eval_<timestamp>/`
...
```bash
python utils/plot_metrics.py output/qual_domain/logs/infinitune-qual-domain/<timestamp>/metrics.csv
```
